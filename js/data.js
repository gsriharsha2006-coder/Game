...
const OPPORTUNITY_EXTRA = {
  ...
  "hack-the-valley": { sector: "Other", stage: "Idea", location: "On-campus", funding: "Prototyping budget", equity: "None", duration: "48 hours", startDate: "Oct 2, 2026", status: "published", views: 355, createdBy: "Hack the Valley Collective" },
  ...
  "healthtech-bootcamp": { sector: "HealthTech", stage: "Idea", location: "On-campus", funding: "Pilot fast-track", equity: "None", duration: "Weekend", startDate: "Sep 18, 2026", status: "published", views: 231, createdBy: "MedFuture Institute" },
...
OPPORTUNITIES.forEach(o => { Object.assign(o, OPPORTUNITY_EXTRA[o.id] || {}); if (!o.status) o.status = "published"; });
